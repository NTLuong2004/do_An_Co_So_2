    ...
    <div class="container-fluid " style="width:100%">
                ...
                <div id="carouselExampleCaptions" class="carousel slide carousel-fade" data-bs-ride="carousel">
                    ...
                    <div class="carousel-inner" style="margin-bottom: 1px solid #000;">
                        <div class="carousel-item active" data-bs-interval="2500">
                            <img src="../images/carosel_Imgs/carosel_1.jpg" class="d-block w-100" alt="...">
                        ...
                        <div class="carousel-item" data-bs-interval="2500">
                            <img src="../images/carosel_Imgs/carosel_3.jpg" class="d-block w-100" alt="...">
                            <div class="carousel-caption d-none d-md-block">
                        ...
                        <div class="carousel-item" data-bs-interval="2500">
                            <img src="../images/carosel_Imgs/carosel_4.jpg" class="d-block w-100" alt="...">
                            <div class="carousel-caption d-none d-md-block">
        ...
        <div class="container_Business bg  ">
            ...
            <div id="section1" style="background-color: #fff;">
                ...
                <div class="container"
                    style=" border: 1px solid #000; border-radius: 10px; padding: 20px !important; height: auto !important ">
                    <h3 class="text-center " style="color: black; margin-bottom: 20px !important">CÁC CÔNG VIỆC HẤP DẪN
                    </h3>
                    <div class="col rounded mx-auto">
                        <!-- Bên trái -->
                        <form class="col-md-8 col-sm-12 verflow-auto rounded"
                            style="height: 120vh; display:block; width: 100% ">
